...
public class UsuarioRolCategoria implements Serializable {
    ...
    public UsuarioRolCategoria(int idRol, int idUsuario, int idCategoria) {
        this.usuarioRolCategoriaPK = new UsuarioRolCategoriaPK(idRol, idUsuario, idCategoria);
    }
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.prn335_2017.guia04.UsuarioRolCategoria[ usuarioRolCategoriaPK=" + usuarioRolCategoriaPK + " ]";
    }
