...
public class PostPaso implements Serializable {
    ...
    public PostPaso(int idPaso, int idPost) {
        this.postPasoPK = new PostPasoPK(idPaso, idPost);
    }
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.prn335_2017.guia04.PostPaso[ postPasoPK=" + postPasoPK + " ]";
    }
