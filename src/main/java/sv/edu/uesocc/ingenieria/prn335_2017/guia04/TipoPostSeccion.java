...
public class TipoPostSeccion implements Serializable {
    ...
    public TipoPostSeccion(int idTipoPost, int idSeccion) {
        this.tipoPostSeccionPK = new TipoPostSeccionPK(idTipoPost, idSeccion);
    }
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.prn335_2017.guia04.TipoPostSeccion[ tipoPostSeccionPK=" + tipoPostSeccionPK + " ]";
    }
