...
public class PostSeccion implements Serializable {
    ...
    public PostSeccion(int idSeccion, int idPost) {
        this.postSeccionPK = new PostSeccionPK(idSeccion, idPost);
    }
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.prn335_2017.guia04.PostSeccion[ postSeccionPK=" + postSeccionPK + " ]";
    }
